...
(function() {
  var Dialog, Mode, STATE, T, centerText, confirm, dialog, dialogs, draw, getCenterX, getCenterY, getPortionH, getPortionW, info, mode, screen, transition, writeJournal, _center, _portion;
  ...
  Mode = {
        ...
        return confirm(dialogs.start, [
          [
            ...
            "embark", "Embark Upon Adventure", function() {
              return transition(Mode.newGame);
            }
          ]
        ]);
      },
    ...
    newGame: {
      init: function() {
        return writeJournal("Shion has chosen to face the new world despite the harsh reality.");
      },
      draw: function() {
        return T._d("DRAW NEW GAME STATE");
      }
    },
    globe: function() {},
    overworld: function() {},
